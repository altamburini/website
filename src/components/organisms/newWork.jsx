...
export default class NewWork extends Component {
  render() {
    return (
		<div>
        <section className="colorlib-blog" data-section="newwork">
...
<h2 className="colorlib-heading">Ediz. PeQuod, pag 245, euro 18, distribuz. Messaggerie, cod. 0 978886068150
