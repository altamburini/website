...
export default class WorksBagaglioLeggero extends Component {
    render() {
        return (
            <div class="modal" id="worksbagaglioleggero" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                <button type="button" class="btn btn-secondary" data-dismiss="modal">CHIUDI</button>
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title"><strong>&quot;Bagaglio Leggero&quot; </strong>(romanzo): <em>peQuod , 2006.</em></h5>
                        ...
                        <div class="modal-body p-4" id="result">
                            <div align="left">
                                ...
                                traccia su tutti. Ma in questo affresco corale di voci incatenate alla malinconia del ricordo, due personaggi
                                troveranno il coraggio di emergere, perchè, di seguito al primo, un secondo ordigno è venuto alla luce,
                                altrettanto deflagrante e in tutt'altra sfera. E per due degli inquilini della Casa la forza del passato sarà la
                                spinta a lasciarsi alle spalle età e memoria, a fuggire da un presente incerto e traditore, proiettati
                                ...
                                Sergio Pent, La Stampa, Tuttolibri. 20/5/06 <br />
                                Fulvio Panzeri, Avvenire. 13/5/06 <br />
                                Marco Lodoli, LA Repubblica, Almanacco dei libri. 29/7/06 <br />
                                Generoso Picone, Il Mattino di Napoli. 30/7/06 <br />
                                Giuseppe Amoroso, La Gazzetta del sud. 20/5/06 <br />
                            ...
                            <div align="center" valign="top"></div>
                                ...
                                <table class="tabella2" height="300" cellSpacing="0" cellPadding="0" width="300">

                                    <tr>
                                        <td align="center" width="100">"Domenica di ricordi, tenera e struggente" di Marco Lodoli.(162k)</td> <td><a href="rec\bagaglioleggero-lodoli.zip"><img
                                            src="./img/rec/bagaglioleggero-lodolismall.jpg"
                                ...
                                <table cellSpacing="0" cellPadding="0" width="300" border="0" vAlign="top" align="middle" bgColor="#ffefce">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="tabelindex">

                                                    Tamburini, vita in casa di riposo<br />
                                                </div>
            ...
            inutili".<br /><br /><br />
                                                ...
                                                <div class="tabelindex"></div>
                                                <div class="tabelindex1">
                                                    Giuseppe Amoroso, La Gazzetta del
            Sud<br /><br />La Casa di riposo "Villa Serena" deve essere
                                                                                                                                                                                        sgombrata a causa del ritrovamento di una bomba, residuato della
                                                                                                                                                                                        seconda guerra mondiale. L'evacuazione, prevista per l'imminente
                                                                                                                                                                                        domenica, innesca subito fra il personale e soprattutto fra gli
                                                                                                                                                                                        anziani ospiti, una grande agitazione, un dilagante senso di
            ...
            passato. <i>Bagaglio leggero</i> è un agile romanzo corale fatto di
                                                                                                                                                                                        ...
                                                                                                                                                                                        una pigna secca fra il bianco del cuscino e quello del lenzuolo";
                                                                                                                                                                                        Francesco, allegro e fanatico del gioco delle carte; il ragionier
                                                                                                                                                                                        Bertini dagli "occhi maligni" e dal pallore mortuario; il Maestro
                                                                                                                                                                                        che porta da anni lo stesso cappello e tiene in mano la vecchia
                                                                                                                                                                                        borsa di scuola; l'imprevedibile Ludovica, soprannominata "la
                                                                                                                                                                                        duchessa", costantemente chiusa nella propria stanza davanti a un
                                                                                                                                                                                        televisore. Nelle memorie che assalgono gli ospiti, passano le
            ...
            <i>La rosa rossa</i> di Quarantotti Gambini, un testo che andrebbe
            ripescato dal buio, e poi l'ironica utopia dei <i>Viaggiatori della
            ...
            l'ultima forma di protesta contro l'abbandono.<br />La situazione
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    tempo, in una babele di flash-back che ci fanno conoscere da vicino
            ...
            l'ultima, forse l'unica di una vita intera.<br />Diciamo onestamente 
                                                    ...
                                                    <div class="tabelindex">
                                                        <hr width="70%"/>
                                                            <br /><br />Vite ritrovate con la forza del passato <br /></div>
                                                        <div class="tabelindex1">
            ...
            <div align="center">Tutti i diritti degli articoli della 
                                                                    rassegna stampa pequodedizioni.it sono di proprietà dei rispettivi 
                                                                    autori/testate/siti. I testi sono riprodotti unicamente a scopo  informativo.</div>
